    ...
    <section class="content-header">
        <center>
            ...
            <div class="row">
                ...
                <input type="text" name="name" class="form-control-plaintext" id="name" placeholder="Ejemplo Daniel" value="{{ old('name') }}">
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-6">
                <input type="text" name="email" class="form-control-plaintext" id="email" placeholder="Sistemas@gmail.com" value="{{ old('email') }}">
