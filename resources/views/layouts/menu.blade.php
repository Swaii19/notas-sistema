...
@canany(['edit_cursos','delete_cursos','view_cursos','create_cursoss'])
<li class="{{ Request::is('cursos*') ? 'active' : '' }}">
    <a href="{{ route('cursos.index') }}"><i class="fa fa-book"></i><span>Eventos</span></a>
</li>
@endcan

@canany(['edit_cursos','delete_cursos','view_cursos','create_cursoos'])
<li class="{{ Request::is('cursos*') ? 'active' : '' }}">
    <a href="{{ route('cursos.index') }}"><i class="fa fa-book"></i><span>Asignaciones</span></a>
</li>
@endcan
